...
<div id="Posts" class="wp-block-group home-post post-loop"
    ...
    <div class="wp-block-query"><!-- wp:post-template -->
        ...
        <div class="wp-block-columns are-vertically-aligned-center"
            style="border-top-color:#dfdfdf;border-top-width:1px;margin-top:0;margin-bottom:0;padding-top:28px;padding-bottom:28px">
            <!-- wp:column {"verticalAlignment":"center","width":"25%"} -->
            <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:25%">
                <!-- wp:post-featured-image {"isLink":true,"style":{"border":{"radius":"5px"}}} /--></div>
            <!-- /wp:column -->

            <!-- wp:column {"verticalAlignment":"center","width":"75%"} -->
            <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:75%">
                <!-- wp:post-title {"isLink":true,"style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"margin":{"top":"0","bottom":"0","left":"0","right":"0"}}},"fontSize":"xxxl-gx"} /-->

                <!-- wp:post-date {"style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"margin":{"top":"0","bottom":"0","left":"0","right":"0"}},"typography":{"fontStyle":"normal","fontWeight":"500"},"color":{"text":"#9e9e9e"}},"fontSize":"bs-gx"} /-->
            </div>
            <!-- /wp:column -->
        </div>
        <!-- /wp:columns -->
